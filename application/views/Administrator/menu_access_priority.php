...
<div id="userAccess">
    ...
    <div class="row" id="accessRow">
        ...
        <div class="col-md-3">
            ...
            <div class="group">
                <input type="checkbox" id="salaryPayment" class="group-head" @click="onClickGroupHeads"> <strong>Salary Module</strong>
                <ul ref="salaryPayment">
                    <li><input type="checkbox" class="access" value="attendance" v-model="access"> Attendance Entry</li>
                    <li><input type="checkbox" class="access" value="attendance_record" v-model="access"> Attendance Record</li>
                    <li><input type="checkbox" class="access" value="salary_payment" v-model="access"> Salary Payment</li>
                    <li><input type="checkbox" class="access" value="employee_statement" v-model="access"> Employee Statement</li>
                    <li><input type="checkbox" class="access" value="salary_slip" v-model="access"> Salary Slip</li>
                    <li><input type="checkbox" class="access" value="salary_due" v-model="access"> Salary Due Report</li>
            </div>
        </div>
        <div class="col-md-3">
            <div class="group">
            ...
            <div class="group">
                ...
                <ul ref="hrPayroll">
                    ...
                    <li><input type="checkbox" class="access" value="salarypayment/deduct" v-model="access"> Salary Deduction</li>
                    <li><input type="checkbox" class="access" value="employee_attendance" v-model="access"> Employee Attendance</li>
                    <li><input type="checkbox" class="access" value="process_salary" v-model="access"> Salary Process</li>
                    ...
                    <li><input type="checkbox" class="access" value="pending_employee_list" v-model="access"> Pending Employees</li>
                    ...
                    <li><input type="checkbox" class="access" value="employeesalaryreport" v-model="access"> Salary Payment Report</li>
                    <li><input type="checkbox" class="access" value="salary_statement" v-model="access"> Salary Statement</li>
                    <li><input type="checkbox" class="access" value="employee_due_report" v-model="access"> Due Report</li>
                    <li><input type="checkbox" class="access" value="attendance_report" v-model="access"> Attendance List</li>
                    <li><input type="checkbox" class="access" value="employee_attendance_report" v-model="access"> Employee Wise Attendance Report</li>
                </ul>
            </div>
            <div class="group">
