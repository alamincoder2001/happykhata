	...
	<div class="row" style="border-bottom:1px solid #ccc;padding: 10px 0;">
		<div class="col-md-12">
			<form class="form-inline" @submit.prevent="showReport">
				...
				<div class="form-group" v-if="reportType == 'records'">
					<input type="date" class="form-control" v-model="dateFrom" style="width:144px;">
				</div>

				<div class="form-group" v-if="reportType == 'records'">
					<input type="date" class="form-control" v-model="dateTo" style="width:144px;">
				</div>
					...
					<table class="table table-bordered table-condensed">
						...
						<tfoot>
							<tr style="font-weight:bold;">
								...
								<td style="text-align:right;">{{ paymentSummary.reduce((prev, curr) => { return prev + parseFloat(curr.due)}, 0) }}</td>
							</tr>
						</tfoot>
					</table>
				</div>
