					...
					<table id="dynamic-table" class="table table-striped table-bordered table-hover">
						...
						?>
							<tr>
								...
								<td class="hidden-480"><?php if($row->status=='a'){ echo '<strong class="text-success">Active</strong>'; }else if($row->status=='d'){ echo '<strong class="text-danger">Inactive</strong>'; } ?></td>
