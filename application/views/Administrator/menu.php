...
if ($module == 'dashboard' or $module == '') {
	...
	<ul class="nav nav-list">
		...
		<li class="">
			<!-- module/Salary -->
			<a href="<?php echo base_url(); ?>module/SalaryModule">
				<i class="menu-icon fa fa-money"></i>
				<span class="menu-text"> Salary Module </span>
			</a>
			<b class="arrow"></b>
		</li>
...
<?php } elseif ($module == 'HRPayroll') { ?>
	<ul class="nav nav-list">
		...
		<?php if (array_search("employee_attendance", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
			<li class="">
		...
		<?php if (array_search("salarypayment/deduct", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
			<li class="">
				<a href="<?php echo base_url(); ?>salarypayment/deduct">
					<i class="menu-icon fa fa-money"></i>
					<span class="menu-text"> Salary Deduction </span>
				</a>
				<b class="arrow"></b>
			</li>
		<?php endif; ?>

		<?php if (array_search("process_salary", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
			<li class="">
				<a href="<?php echo base_url(); ?>process_salary">
					<i class="menu-icon fa fa-money"></i>
					<span class="menu-text"> Salary Process </span>
				</a>
				<b class="arrow"></b>
			</li>
		<?php endif; ?>
		...
		<?php if (array_search("pending_employee_list", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
			<li class="">
				<a href="<?php echo base_url(); ?>pending_employee_list">
					<i class="menu-icon fa fa-list-ol"></i>
					<span class="menu-text"> Pending Employees</span>
				</a>
				<b class="arrow"></b>
			</li>
		<?php endif; ?>
		...
		<?php if (array_search("emplists", $access) > -1 
			...
			|| array_search("salary_statement", $access) > -1 
			|| array_search("employee_due_report", $access) > -1 
			|| array_search("attendance_report", $access) > -1 
			|| array_search("employee_attendance_report", $access) > -1 
			|| isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
			<li class="">
				<a href="<?php echo base_url(); ?>" class="dropdown-toggle">
					<i class="menu-icon fa fa-file"></i>
				...
				<ul class="submenu">
					...
					<?php if (array_search("salary_statement", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
						<li class="">
							<a href="<?php echo base_url(); ?>salary_statement">
								<i class="menu-icon fa fa-caret-right"></i>
								Salary Statement
							</a>
							<b class="arrow"></b>
					...
					<?php if (array_search("employee_due_report", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
						<li class="">
							<a href="<?php echo base_url(); ?>employee_due_report">
								<i class="menu-icon fa fa-caret-right"></i>
								Due Report
							</a>
							<b class="arrow"></b>
					...
					<?php if (array_search("attendance_report", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
						<li class="">
							<a href="<?php echo base_url(); ?>attendance_report">
								<i class="menu-icon fa fa-caret-right"></i>
								Attendance List
							</a>
							<b class="arrow"></b>
					...
					<?php if (array_search("employee_attendance_report", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
						<li class="">
							<a href="<?php echo base_url(); ?>employee_attendance_report">
								<i class="menu-icon fa fa-caret-right"></i>
...
<?php } elseif ($module == 'SalaryModule') { ?>
	<ul class="nav nav-list">
		<li class="active">
			<a href="<?php echo base_url(); ?>module/dashboard">
				<i class="menu-icon fa fa-tachometer"></i>
		...
		<li>
			<a href="<?php echo base_url(); ?>module/SalaryModule" class="module_title">
				<span>Salary Module</span>
			</a>
		</li>

		<?php if (array_search("attendance", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
			<li class="">
				<a href="<?php echo base_url(); ?>attendance">
					<i class="menu-icon fa fa-calendar-check-o"></i>
					<span class="menu-text"> Attendance Entry</span>
				</a>
				<b class="arrow"></b>
			</li>
		<?php endif; ?>

		<?php if (array_search("attendance_record", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
			<li class="">
		...
		<?php if (array_search("employee_statement", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
			<li class="">
				<a href="<?php echo base_url(); ?>employee_statement">
					<i class="menu-icon fa fa-list"></i>
					<span class="menu-text"> Employee Statement </span>
				</a>
				<b class="arrow"></b>
			</li>
		<?php endif; ?>

		<?php if (array_search("salary_slip", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
			<li class="">
				<a href="<?php echo base_url(); ?>salary_slip">
					<i class="menu-icon fa fa-list"></i>
		...
		<?php if (array_search("salary_due", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
			<li class="">
				<a href="<?php echo base_url(); ?>salary_due">
					<i class="menu-icon fa fa-list"></i>
					<span class="menu-text"> Salary Due Report </span>
				</a>
				<b class="arrow"></b>
			</li>
		<?php endif; ?>
