	...
	<div class="row" style="border-bottom: 1px solid #ccc;padding: 3px 0;">
		<div class="col-md-12">
			<form class="form-inline" id="searchForm" @submit.prevent="getSaleReturnDetails">
				...
				<div class="form-group" style="display: none;" :style="{display: selectType == 'user' ? '' : 'none'}">
					<label>User</label>
					<v-select v-bind:options="users" v-model="selectedUser" label="FullName"></v-select>
				</div>
				<div class="form-group" style="display: none;" :style="{display: selectType == 'customer' ? '' : 'none'}">
	...
	new Vue({
		...
		methods: {
			...
			getSaleReturnDetails() {
				...
				let filter = {
					userName: this.selectedUser == null || this.selectedUser.FullName == '' ? '' : this.selectedUser.FullName,
