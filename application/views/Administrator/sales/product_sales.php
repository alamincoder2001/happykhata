...
<div id="sales" class="row">
    <div class="col-xs-12 col-md-12 col-lg-12" style="border-bottom:1px #ccc solid;margin-bottom:5px;">
        <div class="row">
            ...
            <div class="form-group">
                <label class="col-sm-1 col-xs-3 control-label no-padding-right"> Sales From </label>
                <div class="col-sm-2 col-xs-9">
            ...
            <div class="form-group">
                <div class="col-sm-3 col-xs-9 col-xs-offset-3">
                    ...
                    <div class="row">
                        <div class="col-sm-5">
                            <div class="form-group clearfix" style="margin-bottom: 8px;">
                                <label class="col-sm-4 col-xs-4 control-label no-padding-right"> Sales Type </label>
                            ...
                            <div class="form-group">
                                <label class="col-sm-4 col-xs-3 control-label no-padding-right"> Customer </label>
                            ...
                            <div class="form-group" style="display:none;"
                                ...
                                <label class="col-sm-4 col-xs-3 control-label no-padding-right"> Name </label>
                            ...
                            <div class="form-group">
                                <label class="col-sm-4 col-xs-4 control-label no-padding-right"> Mobile No </label>
                                <div class="col-sm-8 col-xs-8">
                            ...
                            <div class="form-group">
                                <label class="col-sm-4 col-xs-3 control-label no-padding-right"> Address </label>
                                <div class="col-sm-8 col-xs-9">
                        ...
                        <div class="col-sm-5">
                            <form v-on:submit.prevent="addToCart">
                                <div class="form-group">
                                    <label class="col-sm-3 col-xs-3 control-label no-padding-right"> Category </label>
                                    <div class="col-sm-8 col-xs-8">
                                        <v-select v-bind:options="categories" v-model="selectedCategory"
                                            label="ProductCategory_Name" v-on:input="categoryOnChange"
                                            placeholder="Select Category"></v-select>
                                    </div>
                                    <div class="col-sm-1 col-xs-1" style="padding: 0;">
                                        <a href="<?= base_url('category')?>" class="btn btn-xs btn-danger"
                                            style="height: 25px; border: 0; width: 27px; margin-left: -10px;"
                                            target="_blank" title="Add New Category"><i class="fa fa-plus"
                                                aria-hidden="true" style="margin-top: 5px;"></i></a>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-3 col-xs-3 control-label no-padding-right"> Product </label>
                                    <div class="col-sm-8 col-xs-8">
                                ...
                                <div class="form-group">
                                    <label class="col-sm-3 col-xs-3 control-label no-padding-right"> Sale Rate </label>
                                ...
                                <div class="form-group">
                                    <label class="col-sm-3 col-xs-3 control-label no-padding-right"> Quantity </label>
                                    <div class="col-sm-9 col-xs-9">
                                ...
                                <div class="form-group" style="display:none;">
                                    <label class="col-sm-3 col-xs-3 control-label no-padding-right"> Discount</label>
                                    <div class="col-sm-9 col-xs-9">
                                        <span>(%)</span>
                                ...
                                <div class="form-group">
                                    <label class="col-sm-3 col-xs-3 control-label no-padding-right"> Amount </label>
                                    <div class="col-sm-9 col-xs-9">
                            ...
                            <div class="table-responsive">
                                <table style="color:#000;margin-bottom: 0px;border-collapse: collapse;">
                                    <tr>
                                        <td>
                                            <div class="form-group">
                                                <label class="col-sm-12 col-xs-3 control-label no-padding-right">Sub
                                                    Total</label>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="form-group">
                                                <label class="col-sm-12 col-xs-3 control-label no-padding-right"> Vat
                                                </label>
                                                ...
                                                <label
                                                    class="col-sm-1 col-xs-1 control-label no-padding-right">%</label>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="form-group">
                                                <label
                                                    class="col-sm-12 col-xs-3 control-label no-padding-right">Discount
                                                    <span class="hidden-xs">Persent</span></label>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="form-group">
                                                <label
                                                    class="col-sm-12 col-xs-3 control-label no-padding-right">Transport
                                                    <span class="hidden-xs">Cost</span></label>
                                                <div class="col-sm-12 col-xs-9">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="form-group">
                                                <label
                                                    class="col-sm-12 col-xs-3 control-label no-padding-right">Total</label>
                                                <div class="col-sm-12 col-xs-9">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="form-group">
                                                <label
                                                    class="col-sm-12 col-xs-3 control-label no-padding-right">Paid</label>
                                                <div class="col-sm-12 col-xs-9">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="form-group">
                                                <label class="col-sm-12 col-xs-3 control-label">Due</label>
