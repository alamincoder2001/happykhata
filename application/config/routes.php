...
$route['updateBrand'] = 'Administrator/Page/
';
...
$route['get_customer_products']	=	'Administrator/Products/getCustomerProducts'; 
$route['get_customer_categories']	=	'Administrator/Products/getCustomerCategories';  
...
$route['get_sales_withOut_details'] = 'Administrator/Sales/getSalesWithOutDetails';
$route['get_sales_record'] = 'Administrator/Sales/getSalesRecord';
$route['get_saledetails'] = 'Administrator/Sales/getSaleDetails';  
$route['get_sale_summary'] = 'Administrator/Sales/getSaleSummary';  
...
$route['pending_employee_list'] = 'Administrator/Employee/pendingEmployeeList';
$route['employee_details/(:any)'] = 'Administrator/Employee/employeeDetails/$1';
...
$route['salarypayment/(:any)'] = 'Administrator/Employee/employeesalarypayment/$1';
...
$route['employee_attendance'] = 'Administrator/Employee/employeeAttendance';
$route['add_employee_attendance'] = 'Administrator/Employee/addEmployeeAttendance';
$route['get_employee_attendance'] = 'Administrator/Employee/getEmployeeAttendance';
$route['attendance_report'] = 'Administrator/Employee/attendanceReport';
$route['employee_attendance_report'] = 'Administrator/Employee/employeeAttendanceReport';
$route['salary_statement'] = 'Administrator/Employee/salaryStatement';
$route['get_employee_ledger'] = 'Administrator/Employee/getEmployeeLedger';
$route['employee_due_report'] = 'Administrator/Employee/employeeDueReport';
$route['get_employee_due_list'] = 'Administrator/Employee/getEmployeeDueList';
$route['process_salary'] = 'Administrator/Employee/processSalary';
$route['generate_salary'] = 'Administrator/Employee/generateSalary';
$route['get_salary_sheet'] = 'Administrator/Employee/getSalarySheet';
$route['salary_sheet/(:any)'] = 'Administrator/Employee/salarySheet/$1';

// attendance
$route['attendance'] = 'Administrator/Employee/attendance';
$route['get_attendance'] = 'Administrator/Employee/getAttendances';
$route['add_attendance'] = 'Administrator/Employee/addAttendance';
$route['update_attendance'] = 'Administrator/Employee/updateAttendance';
$route['attendance_record'] = 'Administrator/Employee/attendanceRecord';
$route['get_attendance_details'] = 'Administrator/Employee/getAttendanceDetails';
$route['attendance-invoice/(:any)'] = 'Administrator/Employee/attendanceInvoice/$1';
$route['salary_slip'] = 'Administrator/Employee/salarySlip';
$route['get_salary_report'] = 'Administrator/Employee/getSalaryReport';

// salary payment
$route['salary_payment'] = 'Administrator/Employee/salaryPayment';
$route['get_employee_due'] = 'Administrator/Employee/getEmployeeDue';
$route['get_salary_payment'] = 'Administrator/Employee/getSalarayPayment';
$route['add_salary_payment'] = 'Administrator/Employee/addSalarayPayment';
$route['update_salary_payment'] = 'Administrator/Employee/upateSalarayPayment';
$route['delete_salary_payment'] = 'Administrator/Employee/deleteSalarayPayment';

$route['employee_statement'] = 'Administrator/Employee/employeeStatement';
$route['get_employee_ledgers'] = 'Administrator/Employee/getEmployeeSalaryLedger';
$route['salary_due'] = 'Administrator/Employee/salaryDueReport';
